	...
	<table id="factura_head">
		<tr>
			...
			<td class="info_empresa">
				<div>
					<span class="h2">FERRECOMM</span>
					<p>Avenida las américas Zona 13, Honduras</p>
					<p>Teléfono: +(504) 3376-4466</p>
					<p>Email: ferrecom@gmail.com</p>
				</div>
			</td>
			<td class="info_factura">
				<div class="round">
					...
					<p>Hora: 10:30am</p>
					<p>Vendedor: kevin adan caceres velasquez</p>
				</div>
			</td>
		</tr>
	</table>
			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
							<td><label>DNI:</label><p>0817200200094</p></td>
							<td><label>Teléfono:</label> <p>33765548</p></td>
						</tr>
						<tr>
