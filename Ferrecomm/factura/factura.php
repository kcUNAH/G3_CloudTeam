	...
	<table id="factura_head">
		<tr>
			...
			<td class="info_empresa">
				<?php
					if($result_config > 0){
						$iva = $configuracion_isv;
				 ?>
				<div>
					<span class="h2"><?php echo strtoupper($configuracion_Nombre_Empresa); ?></span>
					<p><?php echo $configuracion_Direccion; ?></p>
					<p>Teléfono: <?php echo $configuracion_telefono; ?></p>
					<p>Email: <?php echo $configuracion_correo; ?></p>
				</div>
				<?php
					}
				 ?>
			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
							<td><label>Nit:</label><p><?php echo $factura['dni_cliente']; ?></p></td>
