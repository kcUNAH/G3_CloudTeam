      ...
      <div class="modal-content" style="background-color: #fff0">
        ...
        <div class="modal-body">
          <section class="content" style="background-color: #DCFFFE; min-height: auto; width: 110%;">
            <h2 style="text-align: center;  color: rgba(255, 102, 0, 0.91);"> Actualizar Rol <i
...
margin-left: -3px;">
                  ...
                  <div class="panel-body" style="height: auto;" id="formularioregistros2">
                    <form name="formulario2" id="formulario2" method="POST">
                      <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        ...
                        <select id="idestado" name="idestado" class="form-control selectpicker"
  ...
  <section class="home-section">
    ...
    <!-- /////////////////////////////////#DCFFFE/////////////////////////////////////////////////////////////////////-->
    <div id="divModal"></div>
    <h2 style="text-align: center;  color: rgba(255, 102, 0, 0.91);">Roles de usuario <i
                class='bx bxs-cart'></i></h2>
    <main class="app-content" style="background-color: #DCFFFE;">
    <div class="center">    
  <a href="nuevo_rol.php" class="btn_newproducto">Nuevo Rol<i id="icon_nuevo" class='bx bxs-cart-add'></i></a>
