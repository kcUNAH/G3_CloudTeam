...
<body>
  ...
  <h1>  Buscar Roles <i class='bx bxs-user'></i></h1>
    ...
    <section id="container">
     ...
     <?php
      ...
      <section id="container">
        <form action="buscar_rol.php" method="get" class="form_search" style="background-color:#DCFFFE ;">
        <input type="text" name="busqueda" style="text-transform:uppercase; margin-left: 40px" id="busqueda" placeholder="Buscar..." value="<?php echo $busqueda; ?>">
          ...
          <a href="registro_rol.php" class="btn_newproducto"> Añadir ROL<i id="icon_nuevo"
              class='bx bxs-cart-add'></i></a>
             
            <a href="../../../fpdf/Reporte_Roles_Varios.php?buscar=<?php echo $busqueda ?>"   target="_blank" class="btn_pdf"> PDF <i class='bx bxs-file-pdf' ></i></a> 
