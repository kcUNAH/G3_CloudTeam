...
<br>
          <table style="text-align:center;">
            ...
            //Paginador
            $sqlregistre = mysqli_query($conex, "SELECT COUNT(*) AS total_registro FROM tbl_descuentos");
            ...
            if ($result > 0) { //si hay registros
              ...
              while ($data = mysqli_fetch_array($query)) {
                ...
                <tr>
                  ...
                  <td>
                    <?php echo $data["nombre_descuento"] ?>
                  </td>
                  <td>
                    <?php echo $data["porcentaje_descontar"] ?>
                  </td>
                  <td>
                    <a class="link_edit" href="descuentoeditar.php?id=<?php echo $data["id_descuentos"]; ?>"><i
                        class='bx bx-edit'></i></a>
                    <a class="link_delete" href="descuentoeliminar.php?id=<?php echo $data["id_descuentos"]; ?>"><i
