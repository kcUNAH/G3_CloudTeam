      ...
      <div>
            <form action="registro_proveedores.php" method="POST" enctype="multipart/form-data" id="formulario">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="field"  name="nombre_proveedor" id="nombre_proveedor" >
				...
				<div class="formulario__grupo-input">
			    <input type="text" class="field"  name="rtn_proveedor" id="rtn_proveedor" maxlength="14" >
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
            ...
            <div class="formulario__grupo" id="grupo__telefono">
				...
				<div class="formulario__grupo-input">
			<input type="text" class="field"  name="telefono" id="telefono"  maxlength="8">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
				...
				<div class="formulario__grupo-input">
					<input type="text" class="field"  name="direccion" id="direccion" >
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
