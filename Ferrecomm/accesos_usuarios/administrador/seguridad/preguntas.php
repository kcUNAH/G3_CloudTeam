...
<body>
  ...
  <a href="../../../fpdf/Reportepreguntas.php"   target="_blank" class="btn_pdf"> PDF <i class='bx bxs-file-pdf' ></i></a> 
...
<br>
          <table style="text-align:center;">
            ...
            //Paginador
            $sqlregistre = mysqli_query($conex, "SELECT COUNT(*) AS total_registro FROM tbl_ms_preguntas");
