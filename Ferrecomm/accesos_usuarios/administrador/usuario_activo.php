...
<body>
  ...
  <h1>  Lista de Usuarios  Activos<i class='bx bxs-user'></i></h1>
  ...
  <a href="../../fpdf/ReporteActivo.php?buscar=<?php echo $busqueda ?>"   target="_blank" class="btn_pdf"> PDF <i class='bx bxs-file-pdf' ></i></a> 
      ...
      <thead>
       ...
       include 'conex.php';
       //Paginador
       $sqlregistre = mysqli_query($conex, "SELECT COUNT(*) AS total_registro FROM tbl_ms_usuario WHERE estado_usuario = 'ACTIVO'");     
