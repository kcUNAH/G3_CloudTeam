...
<body>
  ...
  <h1>Historial de Inventario Producto<i class='bx bx-package'></i></h1>
  ...
  <a href="../../fpdf/Reporte_NuevoVerMAs.php?buscar=<?php echo $busqueda ?>" target="_blank" class="pdf"> PDF <i class='bx bxs-file-pdf' ></i></a> 
        ...
        <section id="container">
          ...
          <div class="paginador">
            ...
            {
            ?>
              <li><a href="?pagina=<?php echo 1;?>&id=<?php echo $busqueda; ?>">|<</a></li>
              <li><a href="?pagina=<?php echo $pagina -1;?>&id=<?php echo $busqueda; ?>"><<</a></li>
              <?php
              }
              for ($i = 1; $i <= $total_paginas; $i++) {
                ...
                if($i == $pagina){
                  ...
                  echo '<li><a href="?pagina='.$i.'&id='.$busqueda.'">'.$i.'</a></li>';
                }
              }
            if($pagina != $total_paginas){
            ?>
              <li><a href="?pagina=<?php echo  $pagina + 1; ?>&id=<?php echo $busqueda; ?>">>></a></li>
              <li><a href="?pagina=<?php echo $total_paginas;?>&id=<?php echo $busqueda; ?>">>|</a></li>
              <?php 
            } 
            ?>
            </ul>
