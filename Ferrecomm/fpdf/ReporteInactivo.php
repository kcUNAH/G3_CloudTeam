...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE USUARIOS INACTIVOS "), 0, 1, 'C', 0);
      $this->Ln(7);
     ...
     // $this->Cell(40, 10, utf8_decode('Descripcion'), 1, 0, 'C', 1);
      ...
      $this->Cell(45, 20, utf8_decode('Correo Electrónico'), 1, 0, 'C', 1);
...
$descripcion= 'El usuario generó un reporte de usuarios inactivos';
