...
$descripcion= 'El usuario generó un reporte de comprobantes';
...
$pdf->Cell(100, 10, utf8_decode($datos_reporte->nombre), 1, 0, 'C', 0);
$pdf->Cell(100, 10, utf8_decode($datos_reporte->descripcion), 1, 0, 'C', 0);
$pdf->Cell(80, 10, utf8_decode($datos_reporte->estado), 1, 1, 'C', 0);
   }
$i = $i + 1;
/* TABLA */
...
$pdf->Output('ReporteComprobante.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
