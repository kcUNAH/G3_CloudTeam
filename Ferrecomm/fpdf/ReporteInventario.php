...
$descripcion= 'El usuario generó un reporte de inventario';
...
$consulta_reporte_producto = $conexion->query(" SELECT i.id_inventario, p.id_producto, p.nombre_producto, c.nombre_categoria, 
p.unidad_medida, p.cantidad_min, p.cantidad_max, i.cantidad, 
p.precio_producto
