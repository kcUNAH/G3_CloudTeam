...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE DESCUENTOS "), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(180,10, utf8_decode('Nombre'), 1, 0, 'C', 1);
      $this->Cell(100, 10, utf8_decode('Porcentaje descuento'), 1, 1, 'C', 1);
   }
...
$descripcion= 'El usuario generó un reporte de descuentos';
...
$consulta_reporte_producto = $conexion->query("SELECT id_descuentos, nombre_descuento, porcentaje_descontar
FROM tbl_descuentos ORDER BY id_descuentos ASC");
...
$pdf->Cell(180, 10, utf8_decode($datos_reporte->nombre_descuento), 1, 0, 'C', 0);
$pdf->Cell(100, 10, utf8_decode($datos_reporte->porcentaje_descontar), 1, 1, 'C', 0);
   }
$i = $i + 1;
/* TABLA */
...
$pdf->Output('ReporteDescuentos.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
