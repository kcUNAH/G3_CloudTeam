...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100,10, utf8_decode('Categoría'), 1, 0, 'C', 1);
      $this->Cell(180, 10, utf8_decode('Presentación'), 1, 1, 'C', 1);
   }
...
$descripcion= 'El usuario generó un reporte de categorías';
...
$consulta_reporte_producto = $conexion->query("SELECT id_categoria, nombre_categoria, presentacion
FROM tbl_categoria ORDER BY id_categoria ASC");
...
$pdf->Cell(100, 10, utf8_decode($datos_reporte->nombre_categoria), 1, 0, 'C', 0);
$pdf->Cell(180, 10, utf8_decode($datos_reporte->presentacion), 1, 1, 'C', 0);
   }
$i = $i + 1;
/* TABLA */
