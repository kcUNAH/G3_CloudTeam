...
$consulta_reporte_producto = $conexion->query("SELECT id_proveedor, nombre_proveedor, rtn_proveedor, telefono_proveedor, 
correo_proveedor, direccion_proveedor FROM tbl_proveedores  ORDER BY id_proveedor ASC");
