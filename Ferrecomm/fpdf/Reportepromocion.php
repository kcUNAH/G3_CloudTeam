...
$descripcion= 'El usuario generó un reporte de promociones';
...
FROM tbl_promociones p INNER JOIN tbl_estado_promociones e on p.id_estado_prom = e.id_estado_prom ORDER BY p.id_promocion;
");
