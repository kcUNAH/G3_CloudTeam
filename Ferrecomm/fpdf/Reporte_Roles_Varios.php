...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE ROL "), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(60,10, utf8_decode('ROL'), 1, 0, 'C', 1);
      $this->Cell(90, 10, utf8_decode('Descripción'), 1, 0, 'C', 1);
     // $this->Cell(40, 10, utf8_decode('Descripcion'), 1, 0, 'C', 1);
      $this->Cell(45, 10, utf8_decode('Creado Por'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('Modificado Por'), 1, 0, 'C', 1);
...
$descripcion= 'El usuario generó un reporte de roles varios';
...
$consulta_reporte_producto = $conexion->query( "SELECT * FROM tbl_ms_rol
WHERE (rol LIKE '%$busqueda%' OR
...
while ($datos_reporte = $consulta_reporte_producto->fetch_object()) {  
    $pdf->Cell(60, 10, utf8_decode($datos_reporte->rol), 1, 0, 'C', 0);
    $pdf->Cell(90, 10, utf8_decode($datos_reporte->descripcion), 1, 0, 'C', 0);
    //$pdf->Multicell(20, 7, utf8_decode($datos_reporte->descripcion_producto), 1, 'J', false);
    $pdf->Cell(45, 10, utf8_decode($datos_reporte->creado_por), 1, 0, 'C', 0);
    $pdf->Cell(40, 10, utf8_decode($datos_reporte->modificado_por), 1, 0, 'C', 0);
...
$pdf->Output('ReporteBuscarROL.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
