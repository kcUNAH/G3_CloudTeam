...
class PDF extends FPDF
{
   ...
   function Header()
   {
     ...
     $this->Cell(100, 10, utf8_decode("REPORTE DE PERMISOS"), 0, 1, 'C', 0);
     $this->Ln(7);
     ...
     // $this->Cell(40, 10, utf8_decode('Descripcion'), 1, 0, 'C', 1);
      $this->Cell(33, 10, utf8_decode('Permiso inserción'), 1, 0, 'C', 1);
      //$this->Cell(30, 10, utf8_decode('Imagen'), 1, 0, 'C', 1);
      $this->Cell(33, 10, utf8_decode('Permiso eliminar'), 1, 0, 'C', 1);
      $this->Cell(33, 10, utf8_decode('Permiso actualizar'), 1, 0, 'C', 1);
      $this->Cell(33, 10, utf8_decode('Permiso consultar'), 1, 0, 'C', 1);
      $this->Cell(50, 10, utf8_decode('Creado por'), 1, 0, 'C', 1);
...
$descripcion= 'El usuario generó un reporte de permisos';
