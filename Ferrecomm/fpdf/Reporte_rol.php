...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE ROLES"), 0, 1, 'C', 0);
      $this->Ln(7);
...
$descripcion= 'El usuario generó un reporte de roles';
...
$pdf->Output('ReporteRoles.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
