...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("Reporte Cliente "), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(60,10, utf8_decode('DNI'), 1, 0, 'C', 1);
...
$consulta_reporte_producto = $conexion->query( "SELECT * FROM tbl_clientes
...
$pdf->Cell(60, 10, utf8_decode($datos_reporte->dni_cliente), 1, 0, 'C', 0);
...
$pdf->Output('ReporteBuscarCliente.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
