...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE PROMOCIONES DEL PRODUCTOS"), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(100,10, utf8_decode('Promoción'), 1, 0, 'C', 1);
...
$descripcion= 'El usuario generó un reporte de promociones de un producto';
