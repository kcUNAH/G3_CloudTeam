...
<html lang="en">
 ...
 <style>
     ...
     body{
      background-image: URL(https://localhost/G3_CloudTeamEve/Ferrecomm/accesos/Imagenes/Logo.jpeg);
...
<body>
    <div class="row align-items-center justify-content-center mt-5 pt-4" >
          <div class="col-md-5 rounded" style="width: 23rem;" >
            ...
            <h4 style="font-style: italic; center; font-size: 20px; ">Cambiar la contraseña Asignada</h4>
              <hr style="color: #999; background-color: green ; height: 2px; border: none;">
              <form  method="POST" action="contra.js" class="formulario" id="formulario">
                
                <label class="control-label mb-2">Contrase&ntilde;a Actual</label>
                    <div class="input-group mb-3" id="grupo__clave_actual">
